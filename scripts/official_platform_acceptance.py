...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--candidate",
        help="Strict five executable/identity-file candidate directory under active bots/.",
    )
    parser.add_argument(
        "--opponent",
        help="Strict five executable/identity-file opponent directory under active bots/ for non-self-play rounds.",
    )
