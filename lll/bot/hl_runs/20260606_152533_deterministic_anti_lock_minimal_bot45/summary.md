...
- 结论：`GREEN`
- 候选 bot：`bots\experiments\anti_lock_minimal_v1.py`
- 随机种子：`2026360601`
- 每个 baseline 的镜像组数：`5`
...
| --- | ---: | ---: | ---: | ---: | --- |
| `bots\bot4.py` | P0 | 4-1-0 | 2752.8 | 1376.4 | `matchups\current_mirror_bot4.json` |
| `bots\bot5.py` | P0 | 2-3-0 | 530.2 | 265.1 | `matchups\current_mirror_bot5.json` |

## 日志信号

- `branch:preflop_spot_action`: 461
- `branch:lock_win_fold`: 444
- `branch:check_or_pot_control`: 254
- `branch:fold_defense`: 216
- `trace_anti_lock_pressure`: 202
- `branch:call_defense`: 196
- `branch:value_or_pressure_raise`: 149
- `branch:probe_raise`: 101
- `trace_probe_aggressive_bluff_line`: 101
- `branch:anti_lock_preflop_attack`: 55
- `branch:anti_lock_pressure`: 31
- `candidate_high_loss_hand`: 24
