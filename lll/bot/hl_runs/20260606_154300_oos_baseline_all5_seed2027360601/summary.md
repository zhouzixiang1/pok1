...
| --- | ---: | ---: | ---: | ---: | --- |
| `bots\bot1.py` | P0 | 5-0-0 | 3979.6 | 1989.8 | `matchups\current_mirror_bot1.json` |
| `bots\bot2.py` | P0 | 3-2-0 | -1341.6 | -670.8 | `matchups\current_mirror_bot2.json` |
| `bots\bot3.py` | P0 | 2-3-0 | -7665.0 | -3832.5 | `matchups\current_mirror_bot3.json` |
| `bots\bot4.py` | P0 | 3-2-0 | 1646.6 | 823.3 | `matchups\current_mirror_bot4.json` |
| `bots\bot5.py` | P0 | 2-3-0 | -4243.4 | -2121.7 | `matchups\current_mirror_bot5.json` |

## 日志信号

- `branch:lock_win_fold`: 1327
- `branch:preflop_spot_action`: 1095
- `branch:check_or_pot_control`: 678
- `branch:call_defense`: 601
- `branch:fold_defense`: 568
- `branch:value_or_pressure_raise`: 390
- `branch:probe_raise`: 375
- `trace_probe_aggressive_bluff_line`: 375
- `trace_anti_lock_pressure`: 301
- `branch:anti_lock_preflop_attack`: 72
- `trace_probe`: 62
- `branch:anti_lock_pressure`: 58
