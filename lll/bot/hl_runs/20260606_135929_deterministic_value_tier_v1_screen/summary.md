...
- 结论：`GREEN`
- 候选 bot：`bots\experiments\value_tier_v1.py`
- 随机种子：`2026360601`
- 每个 baseline 的镜像组数：`5`
...
| --- | ---: | ---: | ---: | ---: | --- |
| `bots\bot4.py` | P0 | 2-3-0 | -642.4 | -321.2 | `matchups\current_mirror_bot4.json` |
