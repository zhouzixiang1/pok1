...
def value_hand_tier(hole_cards, public_cards, pair_profile=None, board_texture=None, paired_board_profile=None):
    ...
    if hand_class >= 6:
        ...
        if paired_board_profile["board_paired"]:
            if paired_board_profile["fragile_two_pair"]:
                tier = "thin"
...
def choose_raise(
    ...
    if induce_mode and to_call == 0 and value_profile.get("tier") == "nut":
...
def get_action(req, requests):
    ...
    if to_call > 0:
        ...
        semi_bluff = (
            ...
            and opponent_model["fold_to_raise"] > raise_fold_threshold
    ...
    semi_bluff = (
        ...
        and draw_strength >= 0.16
        and opponent_model["confidence"] >= 0.25
        and opponent_model["fold_to_raise"] > semi_bluff_threshold
    )
