"""
Bot 3 - Opponent modeling: smooth_rate, _track_hand_stats, build_opponent_model,
analyze_current_spot, classify_opponent_style.
"""
from constants import N_PLAYERS, BIG_BLIND
from card_utils import clamp, next_player
from state import (
    collect_latest_requests_by_hand, get_hand_index, get_remaining_hands,
    reconstruct_state,
)
...
def classify_opponent_style(opp_model):
    ...
    """
    from constants import N_STYLES
