...
def sanitize_action(action, state, my_chips):
    ...
    # Crossover (v14 import): when facing a stack-sized bet, calling costs our
    # entire stack. v6 used to demote non-allin actions to fold here, which
    # forfeits the equity of any call/raise/check the strategy intended. v14's
    # behavior is correct: only an explicit fold stays a fold; any intention to
    # continue (call/raise/check) becomes an all-in commitment.
