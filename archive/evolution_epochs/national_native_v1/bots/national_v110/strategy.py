...
def choose_preflop_spot_action(req, state, spot_info, opponent_model, preflop_strength, win_rate, match_profile, opp_archetype='unknown'):
    ...
    if spot_info["preflop_spot"] == "bb_vs_limp":
        ...
        # [CROSSOVER from national_v73] Preflop range pruning: fold dominated
        ...
        # Parent B (v73) beats loose-aggressive opponents (v8, v31, v45) where
        # Parent A (v70) loses; the domination penalty is the upstream mechanism
        # v73 uses to shed those dominated hands. Imported here into v70's
        # higher-rated structure + richer opponent model.
        ...
        # [CROSSOVER from national_v73] apply domination penalty so
