#!/usr/bin/env python3
"""Archived national_native_v1 reset utility (v1-v6 only).

This file is retained for historical audit only. It must not be imported or
executed by the active national_tcp_policy_v1 control plane.
...
def main():
    ...
    if not args.force:
        ...
        print(f"  - frozen analysis and replay-memory state")
    ...
    try:
        paths_to_add = ["bots/", "web/core/results/", "web/logs/"]
