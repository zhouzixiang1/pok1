...
def _turn_oop_pot_control(
    ...
    if round_idx != 2 or to_call != 0:
        return None
    # Heads-up contract: dealer_id=SB, bb=1-dealer_id. BB acts first on every
    # postflop street, so OOP on turn = BB. (has_position means my_id==sb=IP.)
...
if __name__ == "__main__":
    ...
    # Case 2: NOT OOP (IP / my_is_bb=False, i.e. SB/dealer) → None
    pc = _turn_oop_pot_control(
