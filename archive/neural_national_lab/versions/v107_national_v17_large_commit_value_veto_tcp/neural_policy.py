...
def _large_commit_value_veto(
    ...
    if to_call < float(cfg.get("large_commit_veto_min_to_call", 8000)):
        return None
    if pot < float(cfg.get("large_commit_veto_min_pot", 18000)):
        return None
    rule_label = _rule_label(rule_action)
    ...
    if rule_value > float(cfg.get("large_commit_veto_max_rule_value", -0.20)):
        return None
    if best_margin < float(cfg.get("large_commit_veto_min_best_margin", 0.45)):
        return None
    return -1
