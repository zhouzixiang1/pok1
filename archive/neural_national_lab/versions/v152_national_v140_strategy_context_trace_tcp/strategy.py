...
from strategy_trace import publish_strategy_context, reset_strategy_context
...
def get_action(req, requests):
    ...
    if should_lock_win(req, state, my_id):
        publish_strategy_context({"lock_win": True})
        return -1
    ...
    strategy_context.update({
        ...
        "draw_profile": draw_info,
        "value_profile": value_profile,
        "board_texture": board_texture,
        "nutted_risk": nutted_risk,
