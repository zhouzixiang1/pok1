...
DEFAULT_CONFIG = {
    ...
    "paid_call_stages": ["preflop", "flop", "turn", "river"],
...
def apply_neural_advice(req: dict[str, Any], state: dict[str, Any], rule_action: int) -> int:
    ...
    if label == 1:
        ...
        allowed_stages = set(cfg.get("paid_call_stages", ["preflop", "flop", "turn", "river"]))
        min_call = float(cfg.get("min_call_chips", 0))
