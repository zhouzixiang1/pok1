"""Archived in-process adapter acceptance runner.
...
def _import_sever_acceptance_modules():
    """Use fully-qualified packages so ``web.server`` cannot shadow TCP code."""

    from archive.botzone_local.sever.bot_adapter import BotAdapter as _BotAdapter
    from sever.engine.deck import Deck as _Deck
    from sever.engine.game import GameEngine as _GameEngine
    from sever.engine.thp_recorder import THPRecorder as _THPRecorder
