"""
Bot 3 - Simulation: opponent range building, weighted equity estimation,
monte carlo and exact river equity.
"""
import bisect
import itertools
import random

from card_utils import clamp, card_number, card_suit, evaluate_7
