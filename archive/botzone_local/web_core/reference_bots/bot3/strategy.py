"""
Bot 3 - Strategy: EXP3 meta-learner, style sizing, opponent pressure,
aggressive line strength, choose_raise, choose_preflop_spot_action, get_action,
safe exploitation, gift tracking, and all action-selection logic.
"""
import math
import random

from constants import (
    N_PLAYERS, BIG_BLIND, INITIAL_CHIPS,
    SIMULATIONS_BY_PUBLIC_COUNT, EXTRA_SIMULATIONS_BY_PUBLIC_COUNT,
    STYLE_NAMES, N_STYLES, STYLE_PARAMS, SIZING_TABLE, SIZING_TIER_RATIOS,
)
from card_utils import clamp, next_player
from state import (
    estimate_preflop_strength, is_preflop_3bet_candidate, is_preflop_trash_hand,
    get_hand_index, get_remaining_hands, reconstruct_state,
    collect_latest_requests_by_hand,
)
from tournament import (
    should_lock_win, fold_gives_opponent_lock,
    match_risk_adjustment, match_pressure_profile,
    apply_anti_lock_pressure, anti_lock_can_continue,
...
from postflop import (
    ...
    value_hand_tier, value_bet_plan, empty_draw_profile,
    draw_profile, draw_call_margin,
    made_flush_profile, blocker_bluff_profile,
    allow_low_frequency_blocker_bluff,
    nutted_risk_profile, postflop_call_margin,
    realized_postflop_equity, check_probe_resistance_margin,
