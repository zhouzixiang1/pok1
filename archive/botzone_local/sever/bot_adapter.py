"""Archived bridge from Botzone JSON bots to the TCP competition server.
...
from sever.server.protocol import parse_preflop, parse_stage_cards, parse_action
from sever.engine.deck import Card
from sever.engine.validator import SMALL_BLIND, BIG_BLIND
