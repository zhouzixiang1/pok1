...
QUALITY_STAGE_EXACT = frozenset().union(
    ...
    CRITICAL_NATIONAL_PLATFORM_EXACT,
    {
        ...
        "web/core/national_native_templates.py",
        "web/core/national_native_templates_bot.py",
        "web/core/national_native_templates_precompute.py",
        "web/core/national_native_templates_probe.py",
