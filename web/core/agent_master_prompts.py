...
def _render_master_proposal_provider_prompt(inputs):
    ...
    output_contract = (
        ...
        "If match analysis contains SATURATOR CONTRACTS or LAST ABANDON RECEIPTS, "
        "address or explicitly reject each hypothesized_symbol; a "
        "prepared_baseline_contract abandon is not a poker patch."
