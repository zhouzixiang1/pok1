...
import official_wire_probe_replay as _owpr  # noqa: E402,F401  (replay cluster)
...
def _causal_raw_transition_issue(
    ...
    *,
    ...
    """Delegate to official_wire_probe_replay."""
    return _owpr._causal_raw_transition_issue(events, finalized=finalized)
...
def _causally_ordered_events(
    ...
    *,
    ...
    """Delegate to official_wire_probe_replay."""
    return _owpr._causally_ordered_events(events, finalized=finalized)
...
def replay_events(
    ...
    *,
    ...
    """Delegate to official_wire_probe_replay."""
    return _owpr.replay_events(events, now=now, finalized=finalized)
...
def _pending_deferred_street_boundary_keys(
    ...
    """Delegate to official_wire_probe_replay."""
    return _owpr._pending_deferred_street_boundary_keys(events)
