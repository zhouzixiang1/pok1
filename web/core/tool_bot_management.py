...
def _validate_active_abandon_claim(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._validate_active_abandon_claim(*args, **kwargs)


def _validate_claim_first_strict_execution_fence(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._validate_claim_first_strict_execution_fence(*args, **kwargs)


def _validate_abandon_workflow_fences(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._validate_abandon_workflow_fences(*args, **kwargs)


def _validate_completed_abandon_workflow_fences(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._validate_completed_abandon_workflow_fences(*args, **kwargs)


def _terminal_gate_abandon_identity(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._terminal_gate_abandon_identity(*args, **kwargs)


def validate_terminal_gate_abandon_fences(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm.validate_terminal_gate_abandon_fences(*args, **kwargs)


def terminal_gate_abandon_fence_proof_if_present(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm.terminal_gate_abandon_fence_proof_if_present(*args, **kwargs)


def validate_completed_abandon_handoff(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm.validate_completed_abandon_handoff(*args, **kwargs)


def _historical_head_is_ancestor(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._historical_head_is_ancestor(*args, **kwargs)


def _historical_completed_abandon_source_proof(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm._historical_completed_abandon_source_proof(*args, **kwargs)


def reprove_historical_completed_abandon(*args, **kwargs):
    """Delegate to tool_bot_management_abandon_fences."""
    return _tbm.reprove_historical_completed_abandon(*args, **kwargs)
