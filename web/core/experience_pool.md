...
## RECENT_LESSONS
- **v248**: The _marginal_made_river_fold_gate (v242, made<0.45 generic) is CONFIRMED as the active leak vs v200/v238/v208 — the offense-axis v248 change does not touch it; future Masters must wire or loosen the dead paired_board_profile param / move SiteB after realized_rate, NOT pursue more sizing or fold-axis work
- **v248**: Unconditional value caps (0.85x) risk leaving chips on the table vs calling-station opponents (low fold_to_raise); if reachability shows the cap is binding vs high-VPIP bots, gate the cap on fold_to_raise>0.45 rather than applying it universally
- **v248 归档建议 (mixed)**: At ≥30g daemon, verify the 0.65–0.85x nut sizing is NOT shadowed by thin_cap or probe_ratio on turn/river vs v200/v238, and separately confirm via net-chips that the _marginal_made_river_fold_gate remains the dominant loss mechanism vs those two — if so, v249 must fix the fold gate (wire paired_board_profile or reposition SiteB), not add more value-sizing refinements.
