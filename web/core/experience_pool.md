...
## RECENT_LESSONS
- **v113**: Critic evidence: H2H weaknesses: v102 vs v106 0.475 (120g) — its sole sub-50% peer; broadway_suited preflop bucket unlikely to move this, v102 vs v103 0.493 (140g), v89 0.493 (150g), v90 0.500 (150g), v92 0.500 (150g) — flat plateau, no specific preflop SB-open or BB-vs-raise leak cited; Experience pool refs: Memory: 'Crossover v107 v102×v89 Jun17 — v102 base + v89 broadway_suited + thin-value probe_mode + barrel fold cap 0.06→0.08' (already tried, committed), Memory: 'crossover v108: v102 base + v89 broadway_suited + remove exhausted barrel-continuation' (also already tried), Memory: 'v101 Barrel-Continuation Fold' — reviewer+critic flagged cap 0.06 may be inert; v113 raises to 0.08 ≈14% which is still small constant tune at plateau; Diff refs: state.py: classify_preflop_hand returns 'broadway_suited' for suited high≥11 low≥10, strategy.py:369,403 — broadway_suited added to implied tier + bb_vs_raise call/bluff bucket only, strategy_helpers.py:302-324 — barrel-fold signal coefficients + cap raised; NO new logic, pure constant retune
