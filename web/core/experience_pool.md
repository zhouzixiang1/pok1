...
## RECENT_LESSONS
- **v87**: Graduated river value tier (v76→lost at v83→restored v87) is a recurring structural pattern that keeps getting rebased away — consider adding it to a 'permanent strategy primitives' list that survives crossovers
- **v87 归档建议**: v86's worst matchup with meaningful sample is vs v47 (40%, 10g) — validate v87's new river value bets ≥100g specifically vs passive-caller lineage (v47/v51/v62), since converting thin checks to 0.50-0.80x pot bets risks value-owning against calling stations that never fold better.
