...
def choose_anti_lock_pressure_action(
    ...
    # v210 ENDGAME TRASH-SHOVE GATE: 63 trash preflop allins at h>=65 cause
    # -20k blowouts. Shoving 200BB with 26o/72o is -EV even in anti-lock mode.
    # Limp/fold instead -- see flop cheaply, preserve chips for postflop play.
    if (round_idx == 0 and my_cards is not None and preflop_strength is not None
            and is_preflop_trash_hand(my_cards, preflop_strength)):
        return 0 if to_call <= BIG_BLIND else -1
