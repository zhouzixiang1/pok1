...
def turn_second_barrel_planner(
    ...
    """OFFENSIVE v129: fire a turn value second-barrel when bot was the flop
    aggressor with top-pair-good-kicker+ on a non-deteriorated board.

    Targets v118's under-aggression leak (turn raise ~33.5%, opp fold-to-turn-bet
    ~99%). Returns raise-to-total amount (int) or None. Orthogonal to every
    defensive fold-gate — does NOT subtract from call_margin / jam_buffer.
    """
