...
def get_action(req, requests):
    ...
    strong += style_deltas.get('call_threshold_delta', 0.0)
    medium += style_deltas.get('call_threshold_delta', 0.0) * 0.7
    ...
    river_bluff_threshold = 0.62 - 0.28 * match_profile["bluff_delta"] - style_deltas.get('bluff_freq_bonus', 0.0)
    probe_fold_threshold = 0.56 - 0.32 * match_profile["bluff_delta"] - style_deltas.get('bluff_freq_bonus', 0.0)
    semi_bluff_threshold = 0.58 - 0.28 * match_profile["bluff_delta"] - style_deltas.get('bluff_freq_bonus', 0.0)
