...
def analyze_current_spot(req, state):
    ...
    # Authoritative heads-up contract: dealer_id IS the small blind,
    ...
    info = {
        "my_is_sb": my_id == sb,
        "my_is_bb": my_id == bb,
        # SB/dealer is in position postflop (BB is OOP). has_position keys on
        # SB so the field correctly represents the in-position postflop role.
