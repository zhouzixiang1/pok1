...
# Mutation (v81 crossover): 0.55 → 0.65 (~18% increase). v79 base has stronger
# postflop structure (checkraise traps, sizing exploit, per-street opp modeling),
# so activating value donks more frequently extracts additional value from the
# passive opponents that v79 loses to (v62/v30/v78 lineage).
_DONK_VALUE_FREQ_CAP = 0.65
