...
from strategy_helpers import (
    ...
    exploit_dispatch, river_value_raise_tier, facing_barrel_continuation,
)
...
def get_action(req, requests):
    ...
    if to_call > 0:
        if round_idx == 0:
            ...
            # CROSSOVER v125 (from v113): barrel-continuation fold signal — tighten
            # call margin vs multi-street barrels. Grounded in pot-odds; only fires
            # when equity is meaningfully below call price. Recovers a defensive
            # primitive v116/v118 dropped; v113's edge vs modern aggressors (v107,
            # v117, v111) traces largely to this signal.
