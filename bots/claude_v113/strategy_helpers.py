...
def facing_barrel_continuation(spot_info, round_idx, made_strength, draw_strength, value_profile, opponent_model, pot, to_call):
    ...
    # MUTATION v113: cap raised 0.07->0.08 (~14% threshold bump)
    # — barrel-fold signal was suspected inert at low cap; widen ceiling
    # to allow stronger fold pressure on deep barrels with high equity deficit.
