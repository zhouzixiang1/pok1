...
def get_action(req, requests):
    ...
    if to_call > 0:
        ...
        # v196: direct river pot-odds-vs-equity fold. The margin-additive
        # dispatch inside _postflop_response_margin is INERT vs polarized value
        # ranges (monte_carlo realized_rate overestimates equity). Fold directly
        # when calibrated_equity (made*discount) < pot_odds. Gate enforces its
        # own conditions: river only, bet>=0.4x pot, made[0.20,0.50),
