...
if __name__ == "__main__":
    ...
    assert _marginal_made_river_fold_gate(
        3, 0.30, 0.00, _thin_value, {}, _value_opp, 400, 1000, None
    ) is False
    assert _marginal_made_river_fold_gate(
        3, 0.40, 0.00, _thin_value, {}, _value_opp, 600, 1000, _trips_vulnerable
    ) is True
    assert _marginal_made_river_fold_gate(
        3, 0.50, 0.00, _strong_value, {}, _value_opp, 600, 1000, None
    ) is False
    assert _marginal_made_river_fold_gate(
        3, 0.30, 0.00, _thin_value, {}, _bluff_opp, 600, 1000, None
    ) is False
    assert _marginal_made_river_fold_gate(
        3, 0.30, 0.00, _thin_value, {}, _low_conf_opp, 600, 1000, None
    ) is False
    assert _marginal_made_river_fold_gate(
