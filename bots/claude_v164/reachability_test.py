...
def main():
    ...
    # --- v163: _flop_cbet_texture_self_test ---
    print("--- v163 _flop_cbet_texture_self_test ---")
    from strategy_helpers import _flop_cbet_texture_self_test
    for ok, delta, expect in _flop_cbet_texture_self_test():
        print("  ok=%s delta=%+.4f expect_sign=%d" % (ok, delta, expect))
