...
from opponent import build_opponent_model, analyze_current_spot, classify_archetype, _aggro_bluffcatcher_should_fold, _rock_value_bet_fold, _board_texture_bluff_raise, _turn_float_value_donk, _postflop_response_margin, _multibarrel_line_fold, _river_potodds_equity_margin, _allin_polarized_equity_fold, _semibluff_raise_construct
...
def get_action(req, requests):
    ...
    if to_call > 0:
        ...
        _value_upsizing = _value_lead_upsizing_delta(
            ...
            board_texture, opponent_model)
        # v233 NEW OFFENSE: semi-bluff raise construction — NEW +EV path
        # creating fold equity with draws vs over-folding opponents.
        if round_idx in (2, 3) and to_call > 0 and not preflop_defensive_only:
