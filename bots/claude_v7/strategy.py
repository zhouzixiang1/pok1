...
def get_action(req, requests):
    ...
    # River overbet bluff (stub, always returns None)
    ...
    if to_call > 0:
        ...
        blocker_raise = (
            ...
            and draw_strength < 0.12
            and allow_low_frequency_blocker_bluff(req, my_cards, public_cards, blocker_profile, round_idx, bluff_freq_bonus=anti_bot4["bluff_freq_bonus"])
        )
        trap_nut_slowplay = (
            round_idx in (1, 2)
