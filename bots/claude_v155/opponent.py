...
def build_opponent_model(requests, my_id):
    ...
    return {
        ...
        "fold_to_open_preflop": smooth_rate(preflop_open_fold, preflop_open_opp, 0.42, 4.0),
        "threebet_vs_open": smooth_rate(preflop_open_3bet, preflop_open_opp, 0.16, 4.0),
        ...
        "turn_to_river_barrel": smooth_rate(barrel_turn_continue, barrel_hands_turn, 0.35, 4.0),
        "barrel_abandon_turn": 1.0 - smooth_rate(barrel_continue, barrel_hands, 0.45, 4.0),
        "barrel_abandon_river": 1.0 - smooth_rate(barrel_turn_continue, barrel_hands_turn, 0.35, 4.0),
