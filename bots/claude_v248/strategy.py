...
def choose_raise(
    ...
    if round_idx >= 2 and value_profile.get("tier") in ("nut", "strong") and not inducing_value and not semi_bluff and not probe_mode and not blocker_bluff and not pressure_line:
