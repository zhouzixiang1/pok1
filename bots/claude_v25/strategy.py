...
def get_action(req, requests):
    ...
    if to_call > 0:
        ...
        if anti_lock_attack is not None:
            return anti_lock_attack
        if round_idx > 0 and not anti_lock_pressure and should_fold_postflop(made_strength, value_profile, board_texture, spot_info, draw_info, pot_odds, to_call, pot, round_idx):
            return -1
