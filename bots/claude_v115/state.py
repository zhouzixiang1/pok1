...
def classify_preflop_hand(my_cards):
    ...
    # CROSSOVER (imported from v108/v89): explicit implied-odds bucket for
    # suited broadways instead of falling into the offsuit 'playable' bucket.
    # These hands flop strong draws / two-pair+ often enough to play vs raises.
