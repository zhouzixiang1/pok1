...
def classify_preflop_hand(my_cards):
    ...
    if suited and high == 14:           # A2s-AJs (AK caught above)
        return "suited_ace"
    # CROSSOVER v121 (from v117/v116/v109/v108/v89): explicit implied-odds bucket
    # for suited broadways (KQs, KJs, QJs, QTs, JTs) instead of falling into the
    # offsuit 'playable' bucket. These hands flop strong draws / two-pair+ often
    # enough to play vs raises with implied odds. v104 lacked this category.
