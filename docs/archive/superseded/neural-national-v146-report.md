...
> **Invalidated by the 2026-07-10 live-pool re-audit.** The claims below are
> retained as historical experiment notes, not current acceptance evidence.
> Against the then-current completed classic pool, v146's incremental bootstrap
> intervals crossed zero and it lost heavily to national_v141. The trainer and
> runtime also disagreed for histories shorter than 16 actions. Do not merge or
> certify v146 from this report. See `docs/neural-national-v146-v150-reaudit.md`.
