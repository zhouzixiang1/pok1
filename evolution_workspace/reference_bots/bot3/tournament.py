"""
Bot 3 - Tournament logic: lock-win detection, fold-gives-lock, match risk/pressure,
anti-lock pressure, anti-lock continue floor/can_continue, anti-lock pressure action.
"""
from constants import (
    N_PLAYERS, BIG_BLIND, LOCK_WIN_MARGIN, TOTAL_HANDS, SMALL_BLIND,
)
