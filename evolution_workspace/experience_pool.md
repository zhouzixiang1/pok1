...
### v6→v7 Confirmed Gaps (Code Review)
- constants.py: missing PREFLOP_STRENGTH_TABLE/CARD_RANKS/SUITS; sim counts wrong
- card_utils.py: inline card math vs precomputed arrays
- state.py: crude formula vs Chen 169-hand lookup
- opponent.py: cbet/drift dead weight, wrong priors, missing anti-bot4
